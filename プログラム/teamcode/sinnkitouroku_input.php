...
$lastname=$name=$f_lastname=$f_name=$mail=$password=$card_namber=$prefectures=$yubin=$city=$banchi_biru=$year=$month='';
echo '1';
...
echo '<form action="tourokuhennkou.php" method="post">';
echo '姓<br>';
